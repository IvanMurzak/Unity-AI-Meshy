...
$VersionFiles = @(
    ...
    @{
        Path        = "Installer/Assets/com.IvanMurzak/AI Meshy Installer/Installer.cs"
    ...
    @{
        ...
        Pattern     = "https://github\.com/IvanMurzak/Unity-AI-Animation/releases/download/[\d\.]+/AI-Meshy-Installer\.unitypackage"
        Replace     = "https://github.com/IvanMurzak/Unity-AI-Animation/releases/download/{VERSION}/AI-Meshy-Installer.unitypackage"
